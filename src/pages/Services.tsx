...
const Services = () => {
  const services = [
    ...
    },
    {
      duration: "45 Minutes",
      price: "Ksh 1,500",
      description: "The ultimate wellness experience. Complete relaxation journey with advanced automated programs for maximum therapeutic benefits.",
      features: ["Complete wellness", "Advanced programs", "Maximum relaxation", "Therapeutic benefits"],
      icon: Sparkles,
      popular: false
    }
  ];
      ...
      <section className="py-20 bg-gradient-to-b from-black to-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gold mb-4">Why Choose Our Automated Massage Chairs?</h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Experience cutting-edge automated technology combined with therapeutic expertise for unparalleled relaxation.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "Intelligent massage programs that provide consistent therapeutic benefits",
                icon: "🤖"
              },
              {
